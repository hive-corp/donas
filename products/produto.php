...
<body>
    <div id="user-product">
        <nav id="nav">
            <div id="nav-list">
                ...
                <a href="../user/pesquisa.php" class="nav-link">
                    <i class="bi bi-search"></i>
                    <span>
                        Pesquisa
                    </span>
                </a>
                <a href="../user/notificacoes.php" class="nav-link">
                    <i class="bi bi-bell"></i> <span>
                        Notificações
                    </span>
                </a>
                <a href="../user/conversas.php" class="nav-link">
                    <i class="bi bi-chat"></i>
                    <span>
                        Conversas
                    </span>
                </a>
                <a href="../user/configuracoes.php" class="nav-link">
    ...
    <script>
        var configuracoes = document.querySelectorAll('.nav-link')[4],
            ...
            enviarComentario = document.querySelector("#enviar"),
