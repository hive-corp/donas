...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Donas na plataforma</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo daoVendedora::contarVendedora() ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card-dashboard card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Usuários na plataforma</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo daoCliente::contarCliente() ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card-dashboard card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Publicações totais na plataforma
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo daoAnuncio::contarAnuncio() ?></div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo daoVendedora::contarVendBloq() ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card-dashboard card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-success">Crescimento da Plataforma - Grafico</h6>
                            ...
                            <div class="card-dashboard card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="customer-wrapper">
                                        ...
                                        <p class="customer-date">24 Ago</p>
                                    </div>
                                    ...
                                    <div class="customer-wrapper">
                                        ...
                                        <p class="customer-date">23 June</p>
                                    </div>
                                    <hr>
                                    <a href="denuncias.php">
                                        <a class="dropdown-item text-center small text-gray-500" style="text-align: center;" href="denuncias.php">Ver Mais</a>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-success">Descrição do Gráfico</h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-circle-fill1" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg> Demora
                                        <br>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-circle-fill2" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg> Entrega
                                        <br>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-circle-fill3" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg> Pedido Errado
                                        <br>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-circle-fill4" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg> Pedido Mal Feito
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-success">Difereça das contas</h6>
                                    </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card-dashboard card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">Categoria</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-pie">
                                    ...
                                    <br><br>
                                    <a href="cadastraCate.php" class="d-sm-inline-block btn btn-sm btn-primary"> Adicionar nova categoria</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../assets/js/Chart/crescimento.js"></script>
    <script src="../assets/js/Chart/denuncias.js"></script>
    <script src="../assets/js/Chart/categoria.js"></script>
    <script src="../assets/js/Chart/tabelas.js"></script>
