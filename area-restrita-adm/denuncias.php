                                      ...
                                      <table class="table align-items-center mb-0">
                                        <thead>
                                          <tr>
                                            ...
                                            <th class="text-uppercase lista">Delator</th>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <p class="text-xs font-weight-bold mb-0">Maria Maravilha</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs font-weight-bold mb-0">Atendimento</p>
                                            </td>
                                            <td class="align-middle text-center"> <a href="ver-mais-denu.php">
