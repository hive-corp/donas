			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row justify-content-center">
						...
						<div class="d-flex px-2 py-1">
							<div class="d-flex flex-column justify-content-center">
								<p class="text-xs text-secondary mb-0 textoVer">E-mail Delator</p>
								<h6 class="text-sm">
						...
						<div class="d-flex px-2 py-1">
							<div class="d-flex flex-column justify-content-center">
								<p class="text-xs text-secondary mb-0 textoVer">Status Delator</p>
								<h6 class="text-sm">
					...
					<div class="row justify-content-center">
						...
						<form method="POST" id="form-subcategoria" action="../api/cliente/alterarStatusD.php"
							...
							class="mr-3">
							<input type="hidden" name="id" value="<?php echo $denuncia['idCliente']; ?>">
