				...
				<div class="container-fluid">
					...
					<div class="row justify-content-center">
						<div class="d-flex px-2 py-1">
							...
							<div class="d-flex flex-column justify-content-center">
								<p class="text-xs text-secondary mb-0 textoVer">Delator</p>
								<h6 class="text-sm">Ana Clara Rocha</h6>
								<div id="linha"></div>
							</div>
						</div>
						...
						<div class="d-flex px-2 py-1">
							<div class="d-flex flex-column justify-content-center">
								<p class="text-xs text-secondary mb-0 textoVer">E-mail</p>
								<h6 class="text-sm">anaRocha@gamil.com</h6>
								<div id="linha"></div>
							</div>
						</div>
						...
						<div class="d-flex px-2 py-1">
							<div class="d-flex flex-column justify-content-center">
								...
								<h6 class="text-sm">Doces Mania</h6>
								<div id="linha"></div>
							</div>
						</div>
					</div>
					...
					<div class="row justify-content-center">
						<div class="d-flex px-2 py-1">
							...
							<div class="d-flex flex-column justify-content-center">
								<p class="text-xs text-secondary mb-0 textoVer">ID da empresa</p>
								<h6 class="text-sm">01</h6>
								<div id="linha"></div>
							</div>
						</div>
						...
						<div class="d-flex px-2 py-1">
							<div class="d-flex flex-column justify-content-center">
								...
								<h6 class="text-sm">07/06/2023</h6>
								<div id="linha"></div>
							</div>
						</div>
						...
						<div class="d-flex px-2 py-1">
							<div class="d-flex flex-column justify-content-center">
								...
								<h6 class="text-sm">Atendimento</h6>
								<div id="linha"></div>
							</div>
						</div>
					</div>
					...
					<div class="row justify-content-center">
						<div class="d-flex px-2 py-1">
							...
							<div class="d-flex flex-column justify-content-center">
								...
								<h6 class="text-sm" style="text-align: center;">No dia 07/06/2023 fui pedir um bolo a empresa Doces Mania.
									Eu como cliente fazia simples <br> perguntas como quais sabores de bolos, recheios, forma de pagamento etc., <br> por sua vez a atendente me atendeu
									com ironias e de forma totalmente desumana. <br> Com esse comportamento da empresa
									decidi cancelar meu pedido. </h6>
								<div id="linhaG"></div>
							</div>
						</div>
					</div>
					...
					<div class="row justify-content-center" data-bs-toggle="modal" data-bs-target="#denunAceita">
						<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Aceitar</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="TituloModalCentralizado" style="display: block; margin-left: auto; margin-right: auto;">Denúncia aceita</h5>
						<button type="button" class="close" data-bs-dismiss="modal" aria-label="Fechar">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<h6 style="text-align: center; font-weight: bold;">Denúncia aceita com sucesso!</h6>
